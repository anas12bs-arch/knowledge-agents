"""
AGENTE 13 — Behavioral Science + Psychology → corpus/psychology/
...
FEEDS = {
    ...
    "ted-ideas":            "https://ideas.ted.com/feed/",
    "freakonomics":         "https://freakonomics.com/feed/",
}
        ...
        for item in root.findall(".//item")[:8]:
            ...
            if title and link:
                p = save(
                    ...
                    source="psychology",
                    category="psychology",
                    tags=["psychology", "behavioral-science", "decision-making",
                          "cognitive-bias", name],
                )
                if p:
                    saved += 1
...
def run():
    ...
    for name, url in FEEDS.items():
        ...
        total += n
        time.sleep(0.3)
    print(f"✅ Psychology: {total} new markdown files written to corpus/")
