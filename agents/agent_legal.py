"""
AGENTE 14 — Legal + Privacy + Compliance → corpus/legal/
  · EFF Deeplinks
  · TechDirt
  · Ars Technica Law/Policy
  · IAPP (privacy)
  · Lawfare blog
"""
...
FEEDS = {
    ...
    "ars-policy":    "https://feeds.arstechnica.com/arstechnica/tech-policy",
        ...
        for item in root.findall(".//item")[:8]:
            ...
            if title and link:
                p = save(
                    ...
                    source="legal",
                    category="legal",
                    tags=["legal", "privacy", "compliance", "gdpr", "regulation", name],
                )
                if p:
                    saved += 1
...
def run():
    ...
    for name, url in FEEDS.items():
        ...
        total += n
        time.sleep(0.3)
    print(f"✅ Legal: {total} new markdown files written to corpus/")
