"""
AGENTE 11 — Sales + Marketing → corpus/sales/
  · HubSpot blog
  · Close.com blog
  · Gong blog
  · SaaStr blog
...
FEEDS = {
    ...
    "close":        "https://blog.close.com/rss/",
    "gong":         "https://www.gong.io/blog/feed/",
        ...
        for item in root.findall(".//item")[:8]:
            ...
            if title and link:
                p = save(
                    ...
                    source="sales",
                    category="sales",
                    tags=["sales", "marketing", "b2b", "saas", "tactics", name],
                )
                if p:
                    saved += 1
...
def run():
    ...
    for name, url in FEEDS.items():
        ...
        total += n
        time.sleep(0.3)
    print(f"✅ Sales: {total} new markdown files written to corpus/")
