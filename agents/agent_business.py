"""
AGENTE 12 — Business Strategy + Startups → corpus/business/
  · Harvard Business Review
  · a16z blog
  · Paul Graham essays
  · Sequoia blog
  · Stratechery-like (free tier)
"""
...
FEEDS = {
    ...
    "nfx":           "https://www.nfx.com/post/rss.xml",
}
        ...
        for item in root.findall(".//item")[:8]:
            ...
            if title and link:
                p = save(
                    ...
                    source="business",
                    category="business",
                    tags=["business", "strategy", "venture", "management", name],
                )
                if p:
                    saved += 1
...
def run():
    ...
    for name, url in FEEDS.items():
        ...
        total += n
        time.sleep(0.3)
    print(f"✅ Business: {total} new markdown files written to corpus/")
